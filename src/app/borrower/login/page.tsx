      ...
      <Card variant="default" className="w-full max-w-md mx-4 p-8">
        <div className="flex flex-col items-center gap-2 pb-2">
          ...
          <p className="text-sm text-slate-500">
            Borrower Portal — Sign in to your account
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-xs text-slate-400">
          <p className="font-medium mb-1">Demo Borrower Accounts:</p>
          <p>james.okonkwo@email.com / +2348012345678</p>
          <p>amina.bello@email.com / +2348023456789</p>
          <p>chidi.nwosu@email.com / +2348034567890</p>
        </div>
      </Card>
    </div>
  );
